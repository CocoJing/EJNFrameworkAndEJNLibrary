...
@implementation API_user_addfav
...
+(API_user_addfav *) create:(id)view_model user_id:(id)user_id target_user_id:(id)target_user_id {

    API_user_addfav *model = [[self alloc] init];
    if( !model ) {
        return nil;
    }
