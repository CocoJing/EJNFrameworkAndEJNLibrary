//
//  API_payment_braintreefindbytoken.m
//  Enjoyney
//
...
@implementation API_payment_braintreefindbytoken
...
+(NSString*) CMD {
    return @"payment.braintreefindbytoken";
}

+(API_payment_braintreefindbytoken *) create:(id)view_model token:(id)token {
    
    API_payment_braintreefindbytoken *model = [[self alloc] init];
    if( !model ) {
        return nil;
    }
