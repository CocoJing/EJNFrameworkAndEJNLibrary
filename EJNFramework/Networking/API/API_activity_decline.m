...
@implementation API_activity_decline
...
+(API_activity_decline *) create:(id)view_model user_id:(id)user_id activity_id:(id)activity_id {

    API_activity_decline *model = [[self alloc] init];
    if( !model ) {
        return nil;
    }
