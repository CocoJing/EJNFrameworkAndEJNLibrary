...
@implementation API_activity_remove
...
+(API_activity_remove *) create:(id)view_model user_id:(id)user_id activity_id:(id)activity_id {

    API_activity_remove *model = [[self alloc] init];
    if( !model ) {
        return nil;
    }
