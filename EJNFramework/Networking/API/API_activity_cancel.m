...
@implementation API_activity_cancel
...
+(API_activity_cancel *) create:(id)view_model user_id:(id)user_id activity_id:(id)activity_id {

    API_activity_cancel *model = [[self alloc] init];
    if( !model ) {
        return nil;
    }
