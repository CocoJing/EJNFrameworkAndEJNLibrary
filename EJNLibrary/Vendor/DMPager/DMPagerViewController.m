...
- (instancetype) initWithViewControllers:(NSArray *) aControllers {
	...
	if (self) {
		...
		_scrollView.backgroundColor = [UIColor colorWithRed:0.074 green:0.078 blue:0.109 alpha:1.000];;
...
- (void)scrollViewDidScroll:(UIScrollView *)aScrollView {
	...
	CGFloat deviation = fabs(aScrollView.contentOffset.x-(sessionCurrentPage*CGRectGetWidth(_scrollView.frame)));
